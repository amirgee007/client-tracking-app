...
return [
    ...
    */
    'attributes' => [
        ...
        'country_id' => 'Land',
        'video' => 'Video URL',
        'gps_location' => 'GPS Locatie',
        'logo_picture' => 'Logo',
        'trip_placeholder_image' => 'Standaard foto voor reis',
        'cover_picture' => 'Cover afbeelding',
        'description' => 'Omschrijving',
        'tagline' => 'Tagline',
        'profile_url' => 'Profiel URL',
        'specialist_country_ids' => 'Landspecialisaties',
        'specialist_holiday_type_ids' => 'Reissoort specialisaties',
        'reisreport_country_ids' => 'Reisreport landen',
        'total_max_trips' => 'Max aantal reizen',
        'total_max_countries' => 'Max aantal landen',
        'total_max_trips_per_country' => 'Max reizen per land',
        ...
        'language'=>'Taal',
        'logo'=>'Logo',
        'total_max_posts'=>'Maximaal aantal artikelen',

        'country' => 'Land',

        'city_name' => 'Plaatsnaam',

        'holiday_type' => 'Reissoort',
        'organisation' => 'Flexibiliteit',

        'brand_id'=>'Reisorganisatie',

        'status_admin'=>'Admin Status',

        'price'=>'Prijs',
        'flight_included'=>'Vlucht inclusief',
        'days'=>'Dagen',

        'holiday_types_ids'=>'Reissoorten',
        'services_included_ids'=>'Onderdelen (inclusief)',
        'services_excluded_ids'=>'Onderdelen (exclusief)',
        'composition_id'=>'Samenstelling',
        'organisation_id'=>'Flexibiliteit',

        'trip_tagline'=>'Tagline',
        'picture'=>'Afbeelding',

        'trip_id'=>'Reis',
        'day_number'=>'Aantal dagen',
        ...
        'confirmation_token'=>'Bevestigings token',

        'two_factor_country_code'=>'Twee-Staps landcode',
        'two_factor_phone'=>'Twee-Staps telefoon',
        'two_factor_options'=>'Twee-Staps opties',
        'remember_token'=>'Onthouden token',


        'ip_address'=>'IP Adres',
        'user_agent'=>'Apparaat/browser',
    ],
];